 ...
 * 修改历史:
 */
public class MerchantListAdapter2 extends CommonRecyclerAdapter<MerchantInfoEntity> {

    private OnUMDItemClickListener listener;

    public MerchantListAdapter2(List<MerchantInfoEntity> datas, Context mContext) {
        super(mContext);
        this.datas = datas;
