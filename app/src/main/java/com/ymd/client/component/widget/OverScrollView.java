...
public class OverScrollView extends FrameLayout implements OnTouchListener {
	...
	/*
	 * 原来的方法，在第一次加载的时候显示不出来。
	 * 
	 * @Override protected void onLayout(boolean changed, int l, int t, int r,
	 * int b) { super.onLayout(changed, l, t, r, b); mIsLayoutDirty = false; //
	 * Give a child focus if it needs it if (mChildToScrollTo != null &&
	 * isViewDescendantOf(mChildToScrollTo, this)) {
	 * scrollToChild(mChildToScrollTo); } mChildToScrollTo = null;
	 * 
