...
public class MyDialog extends Dialog {
	...
	private double width_weight = 0.7;
	...
	public MyDialog(Context context, double width) {
		super(context,R.style.myDialog);
		this.context = context;
	...
	public void setHeadImage(int imageId) {
		switch (imageId) {
			case 0:
				headImageView.setImageResource(R.mipmap.fail_red_icon);
				break;
			case 1:
				headImageView.setImageResource(R.mipmap.success_green_icon);
				break;
			case 2:
				headImageView.setImageResource(R.mipmap.warn_orange_icon);
				break;
			case 3:
				headImageView.setImageResource(R.mipmap.ask_blue_icon);
				break;
			default:
				break;
		}
