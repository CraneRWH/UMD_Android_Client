...
package com.ymd.client.component.widget.progress;
...
public class ProgressHUD {
    ...
    public ProgressHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.common_color_black_txt);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void initViews() {
            mBackgroundLayout = (BackgroundLayout) findViewById(R.id.progress_background);
            ...
            mCustomViewContainer = (FrameLayout) findViewById(R.id.progress_container);
            ...
            mLabelText = (TextView) findViewById(R.id.progress_label);
            setLabel(mLabel, mLabelColor);
            mDetailsText = (TextView) findViewById(R.id.progress_details_label);
