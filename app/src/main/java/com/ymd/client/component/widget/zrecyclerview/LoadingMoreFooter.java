...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView() {
        ...
        progressView.setIndicatorColor(getResources().getColor(R.color.common_color_bg));
        ...
        layoutParams.setMargins((int) getResources().getDimension(R.dimen.mar_pad_len_20px), 0, 0, 0);
