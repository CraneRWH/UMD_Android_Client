package com.ymd.client.component.widget.datepicker;
...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.common_text_color));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.common_text_color));
    }
