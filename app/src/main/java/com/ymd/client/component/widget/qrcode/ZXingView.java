package com.ymd.client.component.widget.qrcode;
...
import com.ymd.client.component.widget.qrcode.code.QRCodeDecoder;
	...
	public String processData(byte[] data, int width, int height) {
		...
		try {
			...
			if (rect != null) {
				...
				source = new PlanarYUVLuminanceSource(data, width, height, 0,
						0, width, height, false);
			}
			rawResult = mMultiFormatReader.decodeWithState(new BinaryBitmap(
