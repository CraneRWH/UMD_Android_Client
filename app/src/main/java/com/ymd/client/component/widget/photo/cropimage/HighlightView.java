 ...
 */
package com.ymd.client.component.widget.photo.cropimage;
...
import com.ymd.client.utils.AbImageUtil;
...
//        mResizeDrawableDiagonal2 = AbImageUtil.bitmapToDrawable(AbFileUtil.getBitmapFormSrc("image/crop_small.png"));
        ...
        mResizeDrawableDiagonal = AbImageUtil.bitmapToDrawable(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.crop_big));
        mResizeDrawableDiagonal2 = AbImageUtil.bitmapToDrawable(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.crop_small));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
               ...
               // mOutlinePaint.setColor(0xFF5BCC7E);
            }
